...
import { TAMANHOS, estilizarBotão, estilizarBotãoRetornar, estilizarBotãoTabela, estilizarCard,
    ...
    estilizarDivider, estilizarFilterMenu, estilizarFlex, estilizarTriStateCheckbox } from "../../utilitários/estilos";
            ...
            <Card title="Administrar Patentes" className={estilizarCard(usuárioLogado.cor_tema)}>
                ...
                >
                    ...
                    <Column 
                        ...
                        sortable 
                    />
                    <Column field="exclusividade_mercado" header="Exclusividade no Mercado" filter
                        showFilterOperator={false}
