...
export default function LogarUsuário() {
  ...
  return (
    <div className={estilizarPáginaÚnica()}>
      ...
      <h1 className={estilizarLogo()}>Patentes da Industria Farmaceutica</h1>
      <Card title="Login" className={estilizarCard()}>
        <div className={estilizarDivCampo()}>
          <label htmlFor="input-nome_login" className={estilizarLabel()}>Usuário</label>
          <InputMask
            id="input-nome_login"
            name="nome_login"
            size={TAMANHOS.CPF}
        ...
        <div className={estilizarDivCampo()}>
          <label htmlFor="input-senha" className={estilizarLabel()}>Senha</label>
          <Password
            inputId="input-senha"
            name="senha"
