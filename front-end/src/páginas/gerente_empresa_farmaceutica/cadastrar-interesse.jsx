...
export default function CadastrarInteresse() {
    ...
    const { interesseConsultado, patenteSelecionada, setPatenteInteresse, setPatenteConsultada } = useContext(ContextoGerenteEmpresaFarmacêutica);
    ...
    function consultarPatenteInteresse() {
        setPatenteConsultada(null);
        setPatenteInteresse(interesseConsultado?.patente);
        ...
        if (interesseConsultado) {
            return (
                <div className={estilizarInlineFlex()}>
                    ...
                    <Button className={estilizarBotão()} label="Patente" onClick={consultarPatenteInteresse}/>
                </div>
            );
        } else {
        return (
