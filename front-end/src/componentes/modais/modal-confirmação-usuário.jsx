...
export default function ModalConfirmaçãoUsuário() {
  ...
  function finalizarCadastro() {
    if (dados.perfil === "pesquisador") {
      setUsuárioLogado({ ...dados, cadastrado: false });
      setMostrarModalConfirmação(false);
      navegar("../cadastrar-pesquisador");
    } else if (dados.perfil === "gerente_empresa_farmaceutica") {
      setUsuárioLogado({ ...dados, cadastrado: false });
      setMostrarModalConfirmação(false);
      navegar("../cadastrar-gerente_empresa_farmaceutica");
  }
}
